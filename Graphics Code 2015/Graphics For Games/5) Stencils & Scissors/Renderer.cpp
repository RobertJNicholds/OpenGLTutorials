...
Renderer::Renderer(Window &parent) : OGLRenderer(parent)
{
	...
	currentShader = new Shader(SHADERDIR"stencilVertex.glsl", 
...
void Renderer::RenderScene()
{
	...
	if (usingScissor)
	{
		...
		glScissor((GLint)((float)width / 2.5f), (GLint)((float)height / 2.5f),
			(GLsizei)((float)width / 5.0f), (GLsizei)((float)height / 5.0f));
	}
