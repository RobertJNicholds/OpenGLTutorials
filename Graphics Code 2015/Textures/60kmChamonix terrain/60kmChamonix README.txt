...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=60kmChamonix&box=7.235955,46.200462,6.457224,45.661481
...
-----------
  ...
  * 60kmChamonix Height Map (ASTER 30m).png
  ...
  * 60kmChamonix Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * 60kmChamonix Height Map (SRTM3 v4.1).png
  ...
  * 60kmChamonix Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 392m (actual) is equal to 40m in
