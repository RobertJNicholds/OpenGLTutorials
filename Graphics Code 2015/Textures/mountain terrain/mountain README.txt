...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=mountain&box=85.534111,28.125902,85.350764,27.964206
...
-----------
  ...
  * mountain Height Map (ASTER 30m).png
  ...
  * mountain Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * mountain Height Map (SRTM3 v4.1).png
  ...
  * mountain Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 1250m (actual) is equal to 40m in
